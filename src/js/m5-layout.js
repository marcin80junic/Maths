    ...
    const layout = {
        exercises: function (module) {
            ...
            html += `<div class="interface-item">
                    ...
                    <select class="level">`;
            m2_resources_1.maths.difficulties.forEach((item, index) => {
            ...
            m2_resources_1.maths.numOfExercises.forEach((item, index) => {
        ...
        main: function (module) {
            let isTest = module.name === "test", isRandomized = (m2_resources_1.maths.settings.general.isRandomized === "true"), isFraction, isAnswer, sign = module.sign, allNumbers = module.numbers, // numbers bank
            ...
            for (let i = 0; i < length; i += 1) {
                ...
                html += '<img src="' + m2_resources_1.maths.icons.questMark + '" class="icon">';
